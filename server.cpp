...
void handlePaxos(std::vector<int>& clientSockets) {
    std::cout << "Handling Paxos..." << std::endl;
    int promiseCount = 0;
    int acceptedCount = 0;
    int proposalID = rand() % 100 + 1; // Initialize proposal ID to a random value between 1 and 100
